    ...
    <main className="flex">
      ...
      <section className="flex-1 bg-image-primary bg-cover sm:bg-none grid w-full">
        <div className="bg-white opacity-95 sm:rounded-xl p-2 grid gap-3">
          ...
          <h1 className="text-center font-['Rubik'] text-5xl">
          ...
          <div id="timer" className="my-7 w-full flex flex-col">
            <div className="flex flex-col justify-center mx-auto">
              <h1 className="text-center">
                Click here if you didn’t receive any link in 2 minutes
              </h1>
              <p id="time" className="text-center font-bold">
                01:59
              </p>
            </div>
            <button
              type="button"
              id="resendLink"
              className="h-12 rounded-xl bg-brown font-['Rubik'] text-primary w-[65%] mx-auto"
            >
              Resend Link
            </button>
          </div>
